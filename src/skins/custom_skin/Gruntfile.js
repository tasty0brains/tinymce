  ...
  grunt.initConfig({
    less: {
      modern: {
        ...
        expand: true,
        rename: function () {
          return "dist/custom_skin/skin.min.css";
        },
        src: ["src/main/less/Skin.less"],
        dest: "dist/custom_skin"
      },
      ...
      content: {
        ...
        expand: true,
        rename: function () {
          return "dist/custom_skin/content.min.css";
        },
      ...
      "content-inline": {
        ...
        expand: true,
        rename: function () {
          return "dist/custom_skin/content.inline.min.css";
        },
